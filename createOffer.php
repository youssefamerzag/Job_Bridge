...
if(isset($_POST['title'] , $_POST['entreprise'], $_POST['description'], $_POST['type'])){
    ...
    $sql->execute([$nextId, $_POST['title'] , $_POST['description'] , $_POST['entreprise'] , $_POST['type'] , $_SESSION['user_id']]);
